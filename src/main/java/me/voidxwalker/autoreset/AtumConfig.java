...
public class AtumConfig implements SpeedrunConfig {
    ...
    public enum AtumGeneratorType {
        ...
        SINGLE_BIOME_CAVES(GeneratorTypeAccessor.atum$SINGLE_BIOME_CAVES(), "Caves"),
        SINGLE_BIOME_FLOATING_ISLANDS(GeneratorTypeAccessor.atum$SINGLE_BIOME_FLOATING_ISLANDS(), "Floating Islands"),
